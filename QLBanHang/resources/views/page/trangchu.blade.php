				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							<b><h4>SẢN PHẨM MỚI</h4><b>
							<div class="beta-products-details">
								<p class="pull-left">Đã tìm thấy {{count($new_product)}} sản phẩm.</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt=""height="270px"></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left"> Đã tìm thấy {{count($sanpham_khuyenmai)}} sản phẩm. </p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="270px"></a>
										</div>
										<div class="single-item-body">
